...
<body>
   ...
   <!--                         <span onclick="javascript:basket.changePNum(1);"><i class="fas fa-arrow-alt-circle-up up"></i></span> -->
            ...
            <div class="right-align basketrowcmd">
                <a href="javascript:void(0)" class="abutton" onclick="javascript:basket.delCheckedItem();">선택구매삭제</a>
                <a href="javascript:void(0)" class="abutton" onclick="javascript:basket.delAllItem();">구매내역지우기</a>
            </div>
    
            <div class="bigtext right-align sumcount" id="sum_p_num">구매갯수: 4개</div>
