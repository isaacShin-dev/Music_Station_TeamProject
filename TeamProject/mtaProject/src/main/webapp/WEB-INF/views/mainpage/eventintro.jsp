...
<html>
   <head>
      ...
      <![endif]-->
      <link rel="stylesheet" href="/resources/include/intro/css/intromusic.css"/>
      <title>MTA 소개.</title>

   </head>
   <body>
   		<video id=introvideo src="/resources/include/video/musicmta.mp4" controls autoplay></video>
   		<a href="mainpagenotlogin" id="gohomepage">Main Home</a>
   </body>
</html>