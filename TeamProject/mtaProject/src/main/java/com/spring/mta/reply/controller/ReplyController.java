package com.spring.mta.reply.controller;
...
public class ReplyController {
	...
	**************************************************************/	
		@GetMapping(value ="/all/{m_no}", produces =MediaType.APPLICATION_JSON_UTF8_VALUE)
		public ResponseEntity<List<ReplyVO>> replyList(@PathVariable("m_no") Integer m_no){
			log.info("List 호출 성공");
			
			ResponseEntity<List<ReplyVO>> entity = null;
			
			entity = new ResponseEntity<>(replyService.replyList(m_no), HttpStatus.OK);
