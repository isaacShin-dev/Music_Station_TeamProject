         ...
         <script type="text/javascript">
         	...
         	$(function() {
	         	...
	         	$("#boardInsertBtn").click(function() {
					//입력값 체크
					if(!chkData("#fn_title","제목은"))return;
					else if(!chkData("#fn_text","작성할 내용은"))return;
				
					else{
						$("#b_writeForm").attr({
							"method" : "post",
							"enctype":"multipart/form-data",
							"action" : "/notice/fnoticeInsert"
						});
         ...
         <form id = "b_writeForm" name = "b_writeForm" >
            <table class="table table-condensed">
               ...
               <tr>
                  ...
                  <td colspan = "3">
                  <input type = "text" value="manager" ></td>
               </tr>   
               <tr>
                  <td class = "ac">글 제 목</td>
                  <td colspan = "3">
                  <input type = "text" id = "fn_title" name = "fn_title"  /></td>
               </tr>
               <tr>
                  <td class = "ac">글 내 용</td>
                  <td colspan = "3">
                  <textarea name = "fn_text" id = "fn_text" rows = "10" cols = "70" ></textarea></td>
               </tr>
